...
Expected: only `WF004` (×12, untouched — out of scope), `WF007` (×2, untouched), `WF011` (×2, untouched, intentional), `WF012` (×1, untouched, out of scope). 17 total, all pre-existing and none introduced by this plan.
